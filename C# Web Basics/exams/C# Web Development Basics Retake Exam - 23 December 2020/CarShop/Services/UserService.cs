...
namespace CarShop.Services
{
    public class UserService : IUserService
    {
        ...
        public void Register(string username, string email, string password, string isMechanic)
        {
            ...
            User user = new User()
            {
                ...
                IsMechanic = isMechanic == "Mechanic",
            };
        ...
        {
            return context.Users.Find(userId).IsMechanic;
        }
    }
}